									...
									<div class="main-content">
										<div class="section__content section__content--p30">
											...
											<div class="row">
												<div class="col-md-12">
													<!-- DATA TABLE -->
													<h3 class="title-5 m-b-35">Data Estimasi Biaya Perangkat Lunak</h3>
													...
													<div class="form-group">
														<form method="get">
															...
															<input class="control-label mb-1" type="date" name="tanggal" >
														...
														<table class="table table-data2">
															<thead>
																<tr>
																	...
																	<th>Tanggal</th>
																	<th>Effort Rate</th>
																	<th>Hasil Function Point</th>
																	<th width="130">Estimasi Usaha</th>
																	<th width="180">Estimasi Biaya</th>
																	<th>Aksi</th>
															...
															<tbody>
																...
																if(isset($_GET['tanggal'])){
																	$tgl = $_GET['tanggal'];
																	$data = mysqli_query($koneksi,"select * from deskripsi where tanggal='$tgl'");
																}else{
																	$data = mysqli_query($koneksi,"select * from deskripsi ORDER BY tanggal DESC");
																}
																...
																while($d = mysqli_fetch_array($data)){
																	...
																	<tr class="tr-shadow">
																		...
																		<td><?php echo number_format($d['total_fp'], 2, '.', ','); ?></td>
																		<td><?php echo number_format($d['total_effort'], 1, '.', ',') ." " . "Bulan";  ?></td>
																		<td><?php echo "Rp " . number_format($d['total_estimasi'], 0, '.', ','); ?></td>
											...
											<div>
												<center><a href="deskripsi.php" class="btn btn-primary btn-sm">Selanjutnya</a></center> 
												<!-- END DATA TABLE --></div>
											</div>
										</div>
										<br/><br/><br/><br/>
